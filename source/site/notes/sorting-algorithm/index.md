...
Увидев [видео](https://www.youtube.com/watch?v=kPRA0W1kECg) с визуализацией сортировок, решил создать свой вариант. Скажу сразу вам скорее всего **никогда** не понадобиться писать свои сортировки. *(Зачем я их пишу? Выглядит красиво + возможно кому-то в вузе понадобиться для сдачи Алгоритмов и Структур данных)*
