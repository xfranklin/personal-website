...
title: Весь JavaScript на одной странице
...
## <span id="2">Переменые, типы данных</span>
...
## <span id="4">Примитивные типы</span>

Всего 5 примитивный типа: числа, строки, логический, undefined, null

### <span id="4.1">Числа</span>
...
### <span id="4.4">Логический тип</span>
...
Символы нужны для создание скрытых свойст объекта, так же есть системные символы внутри JS. Cимволы игнорируються циклом <span class="instr">span</span> и <span class="instr">Object.keys()</span>
...
## <span id="5">Преобразование типов</span>
...
-> ДОПИСАТЬ Дело в том, что «на месте» разрешено вызывать только Function Expression.
```js
...
**Замыкания** - функция объявленая внутри другой функции. Дочерняя функции имеет доступ к переменым родительской функции. Хоть и ее контекст был уничтожен, переменная береться из замыкания.\
